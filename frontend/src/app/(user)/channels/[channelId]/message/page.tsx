    ...
    <div className="relative flex flex-col bg-zinc-950">
      ...
      <div className="sticky bottom-0 -mx-4 -mb-4 shrink-0 border-t border-zinc-800 bg-zinc-950 px-4 pt-2 pb-4 sm:-mx-6 sm:-mb-6 sm:px-6 lg:-mx-8 lg:-mb-8 lg:px-8">
        ...
        <p className="mt-1 text-center text-[11px] text-zinc-700">
          Press <kbd className="rounded bg-zinc-800 px-1 py-0.5 font-mono text-[10px]">Enter</kbd>{' '}
          to send, <kbd className="rounded bg-zinc-800 px-1 py-0.5 font-mono text-[10px]">Esc</kbd>{' '}
          to cancel reply
        </p>
      </div>
    </div>
